...
export default function Home() {
  ...
  const categories = [
    ...
    { name: "Event Management Companies", path: "/adds/EventManagementCompanies" , img : "/assets/cards/eventmanagement.jpg" },
    { name: "Reception Halls", path: "/adds/Receptionhalls" , img : "/assets/cards/receptionhalls.jpg" },
    { name: "Restaurant Promotions", path: "/adds/RestaurantPromotions" , img : "/assets/cards/promotions.jpg" },
      ...
      <div className="relative h-screen">
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center">
          ...
          <div className="w-full max-w-3xl px-4 sm:px-6 md:px-8 space-y-4 sm:space-y-6 md:space-y-8 -mt-8 sm:-mt-12 md:-mt-16 lg:-mt-32">
            ...
            >
              <motion.h1 
                className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold text-white mb-2 tracking-wider"
