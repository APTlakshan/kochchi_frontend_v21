...
const MainThreeCards = () => {
  ...
  const cards = [
    ...
    },
    {
      ...
      description: "Unlock your creativity, boost your knowledge, and stand out from the crowd—reading blogs gives you the edge to win!",
      buttons: [
                    ...
                    <Link href={button.link} passHref key={index}>
                      ...
                      >
                        ...
                        {card.isYouTube && button.isPrimary && (
                          <FaPlayCircle className="inline-block ml-1.5 sm:ml-2 text-base sm:text-lg md:text-xl" />
                        )}
                      </motion.button>
                    </Link>
                  ))}
